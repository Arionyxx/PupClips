...
describe("useFeedStore", () => {
  ...
  it("should set videos and reset index", () => {
    const { result } = renderHook(() => useFeedStore());
    const mockVideos = [
      { id: "1", user_id: "user1", storage_path: "path1", like_count: 0, comment_count: 0 },
      { id: "2", user_id: "user2", storage_path: "path2", like_count: 5, comment_count: 2 },
    ];
  ...
  it("should add videos without duplicates", () => {
    ...
    const newVideos = [
      { id: "1", user_id: "user1", storage_path: "path1", like_count: 0, comment_count: 0 }, // Duplicate
      { id: "2", user_id: "user2", storage_path: "path2", like_count: 5, comment_count: 2 },
    ];
  ...
  it("should update video interaction counts", () => {
    ...
    act(() => {
      result.current.setVideos(mockVideos as any);
      result.current.updateVideoInteraction("1", { like_count: 10, comment_count: 3 });
    });
